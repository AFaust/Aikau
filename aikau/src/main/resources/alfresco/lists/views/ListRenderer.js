...
define(["dojo/_base/declare",
        ...
        "jquery",
        "jqueryui"], 
        function(declare, BaseWidget, _ConstructedWidgetMixin, _KeyNavContainer, KeyboardNavigationSuppressionMixin, _MultiItemRendererMixin, 
                 JsNode, lang, array, domConstruct, on, keys, $) {
   
   return declare([BaseWidget, _ConstructedWidgetMixin, _KeyNavContainer, _MultiItemRendererMixin, KeyboardNavigationSuppressionMixin], {
